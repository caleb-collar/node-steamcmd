...
| Task                                     | Priority | Status  | Notes                 |
| ---------------------------------------- | -------- | ------- | --------------------- |
| 8.1 Add ESM module support               | MEDIUM   | ✅ DONE | Dual CJS/ESM          |
| 8.2 Add `getInstalledApps()` function    | LOW      | ✅ DONE | List installed apps   |
| 8.3 Add `update()` function              | LOW      | ✅ DONE | Update existing       |
